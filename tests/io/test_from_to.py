...
def test_xyz2lammpstrj():
    ...
    with open(fo, "r") as f:
        ...
        assert f.readline() == "ITEM: ATOMS type id x y z\n"
        assert (
            f.readline() == "1  1  2.675830e+00  5.432000e-02  1.151450e+00\n"
        )
        assert (
            f.readline() == "1  2  9.324100e-01  8.932500e-01  2.314510e+00\n"
        )
        assert (
            f.readline() == "1  3  1.234240e+00  4.314200e-01  3.968930e+00\n"
        )
        assert (
            f.readline() == "1  4  4.426360e+00  2.345100e-01  4.969050e+00\n"
        )
        assert (
            f.readline() == "1  5  3.000230e+00  5.555600e-01  5.986930e+00\n"
        )
