...
def test_lammpstrj2inlmp():
    ...
    with open(fo, "r") as f:
        assert f.readline() == "# the first three lines are comments...\n"
        assert f.readline() == "# columns in order: id type x y z ix iy iz\n"
        assert f.readline() == "# input file for LAMMPS generated by exma\n"
        assert f.readline() == "5 atoms\n"
        ...
        assert (
            f.readline()
            == "1  1  2.675830e+00  5.432000e-02  1.151450e+00  0  2  -2\n"
        )
        assert (
            f.readline()
            == "2  1  9.324100e-01  8.932500e-01  2.314510e+00  0  3  -1\n"
        )
        assert (
            f.readline()
            == "3  1  1.234240e+00  4.314200e-01  3.968930e+00  1  0  0\n"
        )
        assert (
            f.readline()
            == "4  2  4.426360e+00  2.345100e-01  4.969050e+00  -1  0  0\n"
        )
        assert (
            f.readline()
            == "5  2  3.000230e+00  5.555600e-01  5.986930e+00  0  1  1\n"
        )
